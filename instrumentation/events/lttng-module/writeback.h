...
#define DEFINE_WRITEBACK_DIRTY_INODE_EVENT(name) \
DEFINE_EVENT(writeback_dirty_inode_template, name, \
	TP_PROTO(struct inode *inode, int flags), \
	TP_ARGS(inode, flags))
DEFINE_WRITEBACK_DIRTY_INODE_EVENT(writeback_dirty_inode_start)
DEFINE_WRITEBACK_DIRTY_INODE_EVENT(writeback_dirty_inode)
DEFINE_WRITEBACK_DIRTY_INODE_EVENT(writeback_mark_inode_dirty)
...
#define DEFINE_WRITEBACK_WRITE_INODE_EVENT(name) \
DEFINE_EVENT(writeback_write_inode_template, name, \
	TP_PROTO(struct inode *inode, struct writeback_control *wbc), \
	TP_ARGS(inode, wbc))
DEFINE_WRITEBACK_WRITE_INODE_EVENT(writeback_write_inode_start)
DEFINE_WRITEBACK_WRITE_INODE_EVENT(writeback_write_inode)
