...
#include "powerpc-64-syscalls_pointers_override.h"
...
#endif
#ifndef OVERRIDE_64_stime
SC_LTTNG_TRACEPOINT_EVENT(stime,
	TP_PROTO(sc_exit(long ret,) __kernel_old_time_t * tptr),
	TP_ARGS(sc_exit(ret,) tptr),
	TP_FIELDS(sc_exit(ctf_integer(long, ret, ret)) sc_inout(ctf_integer(__kernel_old_time_t *, tptr, tptr)))
)
#endif
...
#endif
#ifndef OVERRIDE_64_swapcontext
...
#endif
#ifndef OVERRIDE_64_subpage_prot
SC_LTTNG_TRACEPOINT_EVENT(subpage_prot,
	TP_PROTO(sc_exit(long ret,) unsigned long addr, unsigned long len, u32 * map),
	TP_ARGS(sc_exit(ret,) addr, len, map),
	TP_FIELDS(sc_exit(ctf_integer(long, ret, ret)) sc_inout(ctf_integer(unsigned long, addr, addr)) sc_inout(ctf_integer(unsigned long, len, len)) sc_inout(ctf_integer(u32 *, map, map)))
)
#endif
...
#endif
#ifndef OVERRIDE_64_pciconfig_read
...
#endif
#ifndef OVERRIDE_64_pciconfig_write
...
#endif
#ifndef OVERRIDE_TABLE_64_stime
...
#endif
#ifndef OVERRIDE_TABLE_64_socketcall
...
#endif
#ifndef OVERRIDE_TABLE_64_llseek
...
TRACE_SYSCALL_TABLE(newfstatat, newfstatat, 291, 4)
#endif
...
TRACE_SYSCALL_TABLE(move_pages, move_pages, 301, 6)
#endif
...
#endif
#ifndef OVERRIDE_TABLE_64_subpage_prot
TRACE_SYSCALL_TABLE(subpage_prot, subpage_prot, 310, 3)
#endif
...
TRACE_SYSCALL_TABLE(kexec_file_load, kexec_file_load, 382, 5)
#endif
...
TRACE_SYSCALL_TABLE(io_pgetevents, io_pgetevents, 388, 6)
#endif
#ifndef OVERRIDE_TABLE_64_semtimedop
TRACE_SYSCALL_TABLE(semtimedop, semtimedop, 392, 4)
#endif
